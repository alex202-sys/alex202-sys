...
* **Highlight Project: [Coderr](https://liuhequan.org/) Live** is a e-commerce backend platform designed for handling custom orders, reviews, and assignment workflows. I engineered the complete backend architecture and successfully deployed it in container on a **live server:** [Hosting](https://liuhequan.org/) 
