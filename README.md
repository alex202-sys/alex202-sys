...
* **Highlight Project: Coderr Live Demo** An e-commerce backend platform designed for handling custom orders, reviews, and assignment workflows. I engineered the complete backend architecture and successfully deployed it in container on a **live server:** [Hosting](https://liuhequan.org/) 
The live demo runs a provided template frontend, while the core focus and my main contribution lie entirely in the hosted API and server backend
