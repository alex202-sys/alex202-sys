...
* **Highlight Project: [Coderr](https://github.com/alex202-sys/Coderr) Live** is a e-commerce backend platform designed for handling custom orders, reviews, and assignment workflows. The live demo runs a provided template [frontend](https://github.com/Developer-Akademie-Backendkurs/project.Coderr), while the core focus and my main contribution lie entirely in the hosted API and deployed server backend in container on [Hosting](https://liuhequan.org/).
